...
import '../services/lec_services.dart';
import '../shared/colors.dart';

class PagesectionScreen extends StatefulWidget {
  const PagesectionScreen({super.key});

  @override
  State<PagesectionScreen> createState() => _PagesectionScreenState();
}

class _PagesectionScreenState extends State<PagesectionScreen> {
                    ...
                    onPressed: () async {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          String? result = await LecServices.storeLecApsence(
                              name: _name!,
